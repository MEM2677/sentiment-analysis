...
class OpinionDetailsContainer extends React.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    const { opinion, notificationStatus, notificationMessage } = this.state;
...
OpinionDetailsContainer.propTypes = {
...
OpinionDetailsContainer.defaultProps = {
  onError: () => {},
  config: {},
};

export default withKeycloak(withTranslation()(OpinionDetailsContainer));
