...
1. Go to widget source (<MICROSERVICE_FOLDER>/ui/widgets/opinion/formWidget/>):
   1. Run `npm i`
...
- **opinion.form.createError** (fired when an error occurs during opinion creation)
- **opinion.form.create** (fired when the opinion is successfully created)
- **opinion.form.updateError** (fired when an error occurs during opinion update)
- **opinion.form.update** (fired when the opinion is successfully updated)
