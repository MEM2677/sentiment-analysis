    ...
    <Grid container>
      <Grid item xs={5}>
        <FormControl className={classes.formControl}>
          ...
          >
            <option value="" />
            <option value="id">{t('entities.opinion.id')}</option>
            <option value="username">{t('entities.opinion.username')}</option>
            <option value="pageid">{t('entities.opinion.pageid')}</option>
            <option value="contentid">{t('entities.opinion.contentid')}</option>
            <option value="langcode">{t('entities.opinion.langcode')}</option>
            <option value="created">{t('entities.opinion.created')}</option>
            <option value="text">{t('entities.opinion.text')}</option>
            <option value="sentences">{t('entities.opinion.sentences')}</option>
            <option value="score">{t('entities.opinion.score')}</option>
            <option value="result">{t('entities.opinion.result')}</option>
          </Select>
        </FormControl>
      </Grid>
      <Grid item xs={3}>
