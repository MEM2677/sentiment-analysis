...
1. Go to widget source (<MICROSERVICE_FOLDER>/ui/widgets/opinion/tableWidget/>):
   1. Run `npm i`
...
- **opinion.table.error** (fired when an error occurs)
- **opinion.table.select** (fired when a table row is selected)
